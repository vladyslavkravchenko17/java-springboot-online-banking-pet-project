...
<@c.page>
    ...
    <div class="col-md-8 col-lg-9 content-container align-items-center justify-content-center mt-3">
        <h4>Bank month income reports:</h4>
        <table class="tablemanager mb-3">
            ...
            <#list reports as r>
                <tr>
                    ...
                    <td><a href="/admin/income/month/${r.monthYear}">More</a></td>
                </tr>
            </#list>
            </tbody>
        </table>
        <form>
            ...
            <button class="btn mt-3 rounded-pill btn-lg btn-custom btn-block text-uppercase"
                    formaction="/admin/download/pdf/monthly" formmethod="post">Download PDF
            </button>
            <button class="btn mt-1 mb-3 rounded-pill btn-lg btn-custom btn-block text-uppercase"
                    formaction="/admin/download/excel/monthly" formmethod="post">Download Excel
            </button>
        </form>
    </div>
